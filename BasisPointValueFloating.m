...
for i = 1:length(adj_dates)
    ...
    discount_floating(i) = get_discount_factor_by_zero_rates_linear_interp(reference_date, adj_dates(i), dates, discounts);
    if i == 1
        yf = yearfrac(reference_date, adj_dates(i), 2);
    else
